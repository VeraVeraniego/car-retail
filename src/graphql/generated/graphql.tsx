...
export type OrderedCarsQueryVariables = Exact<{
  orderBy?: InputMaybe<Array<Cars_Order_By> | Cars_Order_By>;
}>;


export type OrderedCarsQuery = { __typename?: 'query_root', cars: Array<{ __typename?: 'cars', batch: any, condition: any, damage_type?: string | null, description?: string | null, id: number, odometer?: number | null, price: any, sale_date: any, title?: string | null, vin: string, year?: number | null, city: { __typename?: 'cities', name: string, id: number, state: { __typename?: 'states', id: number, name: string } }, color: { __typename?: 'colors', id: number, name: string }, model: { __typename?: 'models', id: number, name: string, brand: { __typename?: 'brands', id: number, name: string } } }> };
...
export const OrderedCarsDocument = gql`
...
/**
 * __useOrderedCarsQuery__
 *
 * To run a query within a React component, call `useOrderedCarsQuery` and pass it any options that fit your needs.
 * When your component renders, `useOrderedCarsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useOrderedCarsQuery({
 *   variables: {
 *      orderBy: // value for 'orderBy'
 *   },
 * });
 */
export function useOrderedCarsQuery(baseOptions?: Apollo.QueryHookOptions<OrderedCarsQuery, OrderedCarsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<OrderedCarsQuery, OrderedCarsQueryVariables>(OrderedCarsDocument, options);
      }
export function useOrderedCarsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OrderedCarsQuery, OrderedCarsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<OrderedCarsQuery, OrderedCarsQueryVariables>(OrderedCarsDocument, options);
        }
export type OrderedCarsQueryHookResult = ReturnType<typeof useOrderedCarsQuery>;
export type OrderedCarsLazyQueryHookResult = ReturnType<typeof useOrderedCarsLazyQuery>;
export type OrderedCarsQueryResult = Apollo.QueryResult<OrderedCarsQuery, OrderedCarsQueryVariables>;