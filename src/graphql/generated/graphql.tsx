...
export type FormDataQuery = { __typename?: 'query_root', brands: Array<{ __typename?: 'brands', name: string, id: number }>, states: Array<{ __typename?: 'states', id: number, name: string, cities: Array<{ __typename?: 'cities', id: number, name: string }> }>, colors: Array<{ __typename?: 'colors', id: number, name: string }> };
...
export const Insert_User_Cars_OneDocument = gql`
  ...
  insert_user_cars_one(object: $object) {
    ...
    `;
export type Insert_User_Cars_OneMutationFn = Apollo.MutationFunction<Insert_User_Cars_OneMutation, Insert_User_Cars_OneMutationVariables>;
 ...
 * });
 */
export function useInsert_User_Cars_OneMutation(baseOptions?: Apollo.MutationHookOptions<Insert_User_Cars_OneMutation, Insert_User_Cars_OneMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<Insert_User_Cars_OneMutation, Insert_User_Cars_OneMutationVariables>(Insert_User_Cars_OneDocument, options);
      }
