...
export type Insert_User_Cars_OneMutationVariables = Exact<{
  object: User_Cars_Insert_Input;
}>;

export type Insert_User_Cars_OneMutation = {
  __typename?: "mutation_root";
...
export type Delete_User_CarsMutation = {
  __typename?: "mutation_root";
  delete_user_cars?: {
    __typename?: "user_cars_mutation_response";
    returning: Array<{
...
export type FormDataQuery = {
  __typename?: "query_root";
  brands: Array<{ __typename?: "brands"; name: string; id: number }>;
  states: Array<{
    __typename?: "states";
    id: number;
    name: string;
    cities: Array<{ __typename?: "cities"; id: number; name: string }>;
  }>;
...
`;
export type CreateCarMutationFn = Apollo.MutationFunction<
  CreateCarMutation,
...
export function useCreateCarMutation(
  ...
  return Apollo.useMutation<CreateCarMutation, CreateCarMutationVariables>(
    CreateCarDocument,
    options
  );
}
export type CreateCarMutationHookResult = ReturnType<
  typeof useCreateCarMutation
>;
export type CreateCarMutationResult = Apollo.MutationResult<CreateCarMutation>;
export type CreateCarMutationOptions = Apollo.BaseMutationOptions<
  CreateCarMutation,
  CreateCarMutationVariables
>;
export const Insert_User_Cars_OneDocument = gql`
...
`;
export type Insert_User_Cars_OneMutationFn = Apollo.MutationFunction<
  Insert_User_Cars_OneMutation,
  Insert_User_Cars_OneMutationVariables
>;

/**
 * __useInsert_User_Cars_OneMutation__
 *
 * To run a mutation, you first call `useInsert_User_Cars_OneMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInsert_User_Cars_OneMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [insertUserCarsOneMutation, { data, loading, error }] = useInsert_User_Cars_OneMutation({
 *   variables: {
 *      object: // value for 'object'
 *   },
 * });
 */
export function useInsert_User_Cars_OneMutation(
  baseOptions?: Apollo.MutationHookOptions<
    Insert_User_Cars_OneMutation,
    Insert_User_Cars_OneMutationVariables
  >
  ...
  return Apollo.useMutation<
    Insert_User_Cars_OneMutation,
    Insert_User_Cars_OneMutationVariables
  >(Insert_User_Cars_OneDocument, options);
}
export type Insert_User_Cars_OneMutationHookResult = ReturnType<
  typeof useInsert_User_Cars_OneMutation
>;
export type Insert_User_Cars_OneMutationResult =
  Apollo.MutationResult<Insert_User_Cars_OneMutation>;
export type Insert_User_Cars_OneMutationOptions = Apollo.BaseMutationOptions<
  Insert_User_Cars_OneMutation,
  Insert_User_Cars_OneMutationVariables
>;
...
`;
export type Delete_User_CarsMutationFn = Apollo.MutationFunction<
  Delete_User_CarsMutation,
  Delete_User_CarsMutationVariables
>;
 ...
 * });
 */
export function useDelete_User_CarsMutation(
  baseOptions?: Apollo.MutationHookOptions<
    Delete_User_CarsMutation,
    Delete_User_CarsMutationVariables
  >
  ...
  return Apollo.useMutation<
    Delete_User_CarsMutation,
    Delete_User_CarsMutationVariables
  >(Delete_User_CarsDocument, options);
}
export type Delete_User_CarsMutationHookResult = ReturnType<
  typeof useDelete_User_CarsMutation
>;
export type Delete_User_CarsMutationResult =
  Apollo.MutationResult<Delete_User_CarsMutation>;
export type Delete_User_CarsMutationOptions = Apollo.BaseMutationOptions<
  Delete_User_CarsMutation,
  Delete_User_CarsMutationVariables
>;
...
export const FormDataDocument = gql`
  query FormData {
    brands {
      name
      id
...
export function useFormDataQuery(
  baseOptions?: Apollo.QueryHookOptions<FormDataQuery, FormDataQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<FormDataQuery, FormDataQueryVariables>(
    FormDataDocument,
    options
  );
}
export function useFormDataLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    FormDataQuery,
    FormDataQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<FormDataQuery, FormDataQueryVariables>(
    FormDataDocument,
    options
  );
}
export type FormDataQueryHookResult = ReturnType<typeof useFormDataQuery>;
export type FormDataLazyQueryHookResult = ReturnType<
  typeof useFormDataLazyQuery
>;
export type FormDataQueryResult = Apollo.QueryResult<
  FormDataQuery,
  FormDataQueryVariables
>;
